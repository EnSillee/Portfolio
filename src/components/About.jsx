  ...
  return (
    <div name="about" className="w-full h-screen bg-white">
      <div className="flex flex-col justify-center items-center w-full h-full">
        <div className="max-w-[620px] md:max-w-[1250px] w-full grid grid-cols-1 gap-8">
          <div className=" jua mx-auto mb-6 text-3xl md:text-5xl inline border-b-4 border-green-300 pt-48 md:pt-0">
            About Me
          </div>
        </div>
          ...
          <div className=" sm:text-right text-4xl">
            <span className=''>
              <img
                src={profileimg}
                alt="profile"
                className=" mx-auto w-[16rem] sm:w-[20rem] md:w-[24rem] "
              />
            </span>
          </div>

          <div className='nanum'>
            <p className=' mt-4 pb-3 md:pt-0 md:mt-8 text-sm md:text-lg  lg:text-xl'>
            ...
            <p className=' pb-3 text-sm md:text-lg '>
            ...
            <p className=' pb-20 mb-12 text-sm md:text-lg md:pb-0'>
